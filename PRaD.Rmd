---
  title: "  O que é a Pesquisa Real à Distância (PRaD)"
---
...
#### PRaD no *Science Internship Program* (SIP)

No SIP, a PRaD é praticada durante os verões do hemisfério norte. Há práticas para a educação à distância que permitem maior eficiência no processo da PRaD. [Clique para obter mais informações sobre como ter uma educação à distância mais eficaz](https://www.aritzhaupt.com/distance_education/research-methods/)


#### PRaD no *Treehouse Undergraduate Bioinformatics Internship* (TUBI)
...
O PAEI nasce como uma implementação da PRaD como consequência do caráter tecnológico das ciências genômicas no que se refere às linguagens de programação computacional.

#### PRaD no Brasil

A pesquisa na modalidade à distância é objeto de investimentos da Coordenação de Aperfeiçoamento de Pessoal de Nível Superior (CAPES).
