...
![Reference panels can be used to create populational references. With milions or billions of sequences deposited in a database, a genetic model can be created or imputed. Figure from @tellmeGen.](./images/imputação.png){width=40%}
