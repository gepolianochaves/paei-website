...
Para verificação da variável raça/cor foi utilizado o vídeo do Fábio Rocha @Rocha2023 Referencia:
https://www.youtube.com/watch?v=3jLhC2PXi3M
...
```{r check dataframe, message=F, eval=F}
library(expss)
